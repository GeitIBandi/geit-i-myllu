...
public class GeitIMyllu {
    ...
    private int updateGameState(int gameState) {
	if(gameWon() == false && boardFull() == true) {
	    ties++;
	    return 5;
	}
	else if(gameWon() == true && getGameState() == 1) {
	    gamesWonByPlayerX++;
	    return 3;
	}
	else if(gameWon() == true && getGameState() == 2) {
	    gamesWonByPlayerO++;
	    return 4;
	}
	...
	return ((checkRowColDiag(getCell(0,0), getCell(1,1), getCell(2,2)) == true)
		 || (checkRowColDiag(getCell(0,2), getCell(1,1), getCell(2,0)) == true));
    }
	...
	for(int i = 0; i < 3; i++)
	{
	    if(checkRowColDiag(getCell(0,i), getCell(1,i), getCell(2,i)) == true)
		return true;
	}
	return false;
    }
	...
	for(int i = 0; i < 3; i++)
	{
	    if(checkRowColDiag(getCell(i,0), getCell(i,1), getCell(i,2)) == true)
		return true;
	}
	return false;
    }
	...
	if(checkRowsForWin() == true || checkColsForWin() == true || checkDiagForWin() == true)
	    return true;
	return false;
    }
